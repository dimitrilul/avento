...
export function TrendChart({ data }: { data: TrendPoint[] }) {
  ...
  return (
    <ResponsiveContainer width="100%" height={290}>
      <AreaChart data={formatted} margin={{ top: 12, right: 6, bottom: 0, left: -18 }}>
        <defs>
        ...
        <YAxis unit=" km" axisLine={false} tickLine={false} tick={{ fill: theme.palette.text.secondary, fontSize: 12 }} />
        <Tooltip
